(function() {
  ...
  describe('slug', function() {
    ...
    it('should leave allowed chars in rfc3986 mode', function() {
      var a, allowed, _i, _len, _results;
      allowed = ['.', '_', '~'];
      _results = [];
    ...
    it('should leave allowed chars in pretty mode', function() {
      ...
      for (_i = 0, _len = allowed.length; _i < _len; _i++) {
        a = allowed[_i];
        _results.push([slug("foo " + a + " bar baz")].should.eql(["foo-" + a + "-bar-baz"]));
      }
      return _results;
    });
    it('should replace latin chars', function() {
      var char, char_map, replacement, _results;
      char_map = {
        'À': 'A',
        'Á': 'A',
        'Â': 'A',
      ...
      for (char in char_map) {
        ...
        _results.push([slug("foo " + char + " bar baz")].should.eql(["foo-" + replacement + "-bar-baz"]));
      }
      return _results;
    });
    ...
    it('should replace cyrillic chars', function() {
      var char, char_map, expected, replacement, _results;
      char_map = {
        'а': 'a',
        'б': 'b',
        'в': 'v',
      ...
      for (char in char_map) {
        ...
        _results.push([slug("foo " + char + " bar baz")].should.eql([expected]));
      }
      return _results;
    });
    ...
    it('should remove ellipsis in pretty mode', function() {
      ...
      for (char in char_map) {
        replacement = char_map[char];
        _results.push([slug("foo " + char + " bar baz")].should.eql(["foo-bar-baz"]));
      }
      return _results;
    });
    ...
    it('should strip symbols', function() {
      var char, char_map, _i, _len, _results;
      char_map = ['†', '“', '”', '‘', '’', '•'];
      _results = [];
      for (_i = 0, _len = char_map.length; _i < _len; _i++) {
        char = char_map[_i];
        _results.push([slug("foo " + char + " bar baz")].should.eql(["foo-bar-baz"]));
      }
      return _results;
